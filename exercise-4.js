...
Dan apabila didalam modus hanya ada 1 nilai yang sama maka function akan me-return -1, 
...
function cariModus(arr){
	...
	for (var j= 0; j < freq.length; j++) {
		...
		if (terbesar <= 1 || freq.length===1) return -1;
		return a[freq.indexOf(terbesar)]
}
